...
AltaeraAI is a [Termux](https://github.com/termux) wrapper that packages [KoboldCpp 1.65](https://github.com/LostRuins/koboldcpp) and Kobold Lite UI for native usage on Android devices.
