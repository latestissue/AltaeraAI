...
wget https://github.com/latestissue/altaera-packages.github.io/releases/download/v2.4/altaera-v2.4.tar.gz
tar -xf 'altaera-v2.4.tar.gz'
rm -rf 'altaera-v2.4.tar.gz'
