...
distro_setup() {
	...
	run_proot_cmd pacman -S wget procps git clang make python3 blas-openblas fakeroot --noconfirm
	run_proot_cmd wget --no-check-certificate https://raw.githubusercontent.com/latestissue/AltaeraAI/main/scripts/altaera_install_pt-3-slow.sh -O 'altaera_install_pt-3.sh'
