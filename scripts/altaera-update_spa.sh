...
case $CHOICE in
        ...
        1)
            ...
            wget https://raw.githubusercontent.com/latestissue/AltaeraAI/main/scripts/altaera-update_content_spa-fast.sh -O 'altaera-update_content.sh'
        ...
        2)
            ...
            wget https://raw.githubusercontent.com/latestissue/AltaeraAI/main/scripts/altaera-update_content_spa-slow.sh -O 'altaera-update_content.sh'
            chmod a+x 'altaera-update_content.sh'
            } &> /dev/null 2>&1;
            bash 'altaera-update_content.sh'
            clear
