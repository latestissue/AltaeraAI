...
wget https://github.com/latestissue/AltaeraAI/releases/download/v3.4/altaera-v3.4.tar.gz
tar -xf 'altaera-v3.4.tar.gz'
cd 'kcpp-ae'
rm -rf 'models'
rm -rf 'klite.embd'
...
rm -rf '/data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/altaera/root/altaera-v3.4.tar.gz'
