...
find './' -name '*.bin' -exec cp -prv '{}' '/data/data/com.termux/files/home/AltaeraAI-tmp' ';'
...
find './' -name '*.bin' -exec cp -prv '{}' '/data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/altaera/root/koboldcpp-altaera' ';'
