...
case $CHOICE in
        ...
        3)
            ...
            chmod a+x 'altaera-force_update.sh'
            rm -rf 'altaera-customer_support.sh'
            wget https://raw.githubusercontent.com/latestissue/AltaeraAI/main/scripts/altaera-customer_support_chn.sh -O 'altaera-customer_support.sh'
            chmod a+x 'altaera-customer_support.sh'
            cd '/data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/altaera/root/koboldcpp-altaera'
            rm -rf 'prompts'
            mkdir 'prompts'
        ...
        4)
            ...
            chmod a+x 'altaera-force_update.sh'
            rm -rf 'altaera-customer_support.sh'
            wget https://raw.githubusercontent.com/latestissue/AltaeraAI/main/scripts/altaera-customer_support_ger.sh -O 'altaera-customer_support.sh'
            chmod a+x 'altaera-customer_support.sh'
            cd '/data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/altaera/root/koboldcpp-altaera'
            rm -rf 'prompts'
            mkdir 'prompts'
        ...
        5)
            ...
            rm -rf 'altaera-force_update.sh'
            rm -rf 'altaera-customer_support.sh'
            wget https://raw.githubusercontent.com/latestissue/AltaeraAI/main/scripts/altaera-customer_support_spa.sh -O 'altaera-customer_support.sh'
            chmod a+x 'altaera-customer_support.sh'
        ...
        8)
            ...
            chmod a+x 'altaera-force_update.sh'
            rm -rf 'altaera-customer_support.sh'
            wget https://raw.githubusercontent.com/latestissue/AltaeraAI/main/scripts/altaera-customer_support_jpn.sh -O 'altaera-customer_support.sh'
            chmod a+x 'altaera-customer_support.sh'
            cd '/data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/altaera/root/koboldcpp-altaera'
            rm -rf 'prompts'
            mkdir 'prompts'
        ...
        9)
            ...
            chmod a+x 'altaera-force_update.sh'
            rm -rf 'altaera-customer_support.sh'
            wget https://raw.githubusercontent.com/latestissue/AltaeraAI/main/scripts/altaera-customer_support_krn.sh -O 'altaera-customer_support.sh'
            chmod a+x 'altaera-customer_support.sh'
            cd '/data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/altaera/root/koboldcpp-altaera'
            rm -rf 'prompts'
            mkdir 'prompts'
        ...
        10)
            ...
            chmod a+x 'altaera-force_update.sh'
            rm -rf 'altaera-customer_support.sh'
            wget https://raw.githubusercontent.com/latestissue/AltaeraAI/main/scripts/altaera-customer_support_pol.sh -O 'altaera-customer_support.sh'
            chmod a+x 'altaera-customer_support.sh'
            cd '/data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/altaera/root/koboldcpp-altaera'
            rm -rf 'prompts'
            mkdir 'prompts'
        ...
        11)
            ...
            chmod a+x 'altaera-force_update.sh'
            rm -rf 'altaera-customer_support.sh'
            wget https://raw.githubusercontent.com/latestissue/AltaeraAI/main/scripts/altaera-customer_support_por.sh -O 'altaera-customer_support.sh'
            chmod a+x 'altaera-customer_support.sh'
            cd '/data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/altaera/root/koboldcpp-altaera'
            rm -rf 'prompts'
            mkdir 'prompts'
