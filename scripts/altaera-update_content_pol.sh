...
rm -rf 'lang.sh'
wget https://raw.githubusercontent.com/latestissue/AltaeraAI/main/scripts/altaera-ubuntu/lang.sh
chmod a+x 'lang.sh'
...
wget https://raw.githubusercontent.com/latestissue/AltaeraAI/main/scripts/altaera-updated_successfully_pol.sh -O 'altaera-updated_successfully.sh'
...
rm -rf 'upgrade.sh'
wget https://raw.githubusercontent.com/latestissue/AltaeraAI/main/scripts/altaera-ubuntu/upgrade.sh
chmod a+x 'upgrade.sh'
rm -rf 'ngrok-authtoken.sh'
wget https://github.com/latestissue/AltaeraAI/releases/download/v2.9/altaera-v2.9.tar.gz
tar -xf 'altaera-v2.9.tar.gz'
